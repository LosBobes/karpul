// Vendored from fancy (https://fancycomponents.dev/r/scramble-hover.json), MIT,
// by Daniel Petho. Local edits: dropped the Next.js "use client" directive and
// swapped NodeJS.Timeout for ReturnType<typeof setInterval> (no @types/node
// here), and dropped an unused state setter (noUnusedLocals).
...
const ScrambleHover: React.FC<ScrambleHoverProps> = ({
  ...
  // Upstream mutates this Set in place rather than going through a setter, so
  // the setter is dropped here to satisfy noUnusedLocals.
